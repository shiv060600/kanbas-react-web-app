...
import {BootstrapGrids, DramaticGrids} from "./BootstrapGrids";
import { ResponsiveGrids } from "./BootstrapGrids";
import ScreenSizeLabel from "./ScreenSizeLabel";
import { BootstrapTables,ResponsiveForm,ResponsiveTables } from "./BootsrapTables";
import { StylingList, HyperlinkList } from "./BoostrapLists";
import { StylingAddons, StylingDropdowns,StylingForms,StylingRangeSliders,StylingSwitches } from "./BootstrapForms";
import { TabNavigation , NavigatingCards } from "./BoostrapNavigation";
export default function Lab2() {
  return (
    <div className="container">
      ...
      <div id = "wd-boostrap-grids">
        <BootstrapGrids/>
      </div>
      <div id = "wd-responsive-grids">
        <ResponsiveGrids />
      </div>
      <div id = "wd-dramatic-grids">
        <DramaticGrids />
      </div>
      <div id = "wd-screen-size-label">
        <ScreenSizeLabel />
      </div>
      <div id = "wd-boostrap-tables">
        <BootstrapTables/>
        <ResponsiveTables/>
      </div>
      ...
      <div id = "wd-tab-navigation">
          <TabNavigation/>
      </div>
      <div id = "wd-card-navigation">
        <NavigatingCards/>
      </div>
